...
export const setStatusAC=(status:StatusType)=>({type:'SET-STATUS', status: status} as const)
export const setErrorAC=(error:string|null)=>({type:'SET-ERROR', error: error} as const)